...
app.controller('CustomerCtrl',function($scope,$http){
	$http.get("https://localhost:44373/api/customers/"+localStorage.getItem("user")).then(function(resp){
		debugger;
...
app.controller('ProductCtrl',function($scope,$http){
	$http.get("https://localhost:44373/api/admins/product").then(function(resp){
		debugger;
